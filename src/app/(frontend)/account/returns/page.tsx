  ...
  return (
    <main className="space-y-8">
      ...
      <div className="bg-cream-50 rounded-2xl border border-cream-200 p-5 text-sm text-muted-foreground space-y-2">
        <p className="font-medium text-foreground">退換貨須知</p>
        <ul className="space-y-1 list-disc list-inside">
          <li>商品到貨後 7 天內可申請退換貨</li>
          <li>商品需保持原包裝、未拆封、未使用</li>
          <li>個人衛生用品（貼身衣物等）恕不接受退換</li>
          <li>退款將於收到退回商品後 3-5 個工作天處理</li>
          <li>換貨若產生價差，將另行通知補退差額</li>
        </ul>
      </div>
    </main>
  )
