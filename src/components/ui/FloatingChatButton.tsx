  ...
  return (
    <div data-component="floating-chat" className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-gold-500 text-white shadow-lg hover:bg-gold-600 transition-all hover:scale-105 active:scale-95 flex items-center justify-center"
        aria-label="聯絡客服"
      >
